...
const UserLogin = (props) => {
    ...
    const getResult = async (user_email, user_password) => {
        ...
        try {
            ...
            let res = await axios.post(
                `${Environment_variable.BackEnd_URL}/api/user/user_login`,
                post_body,
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        getResult( user_email, user_password)
    }
    ...
    return (
        <div>
            ...
            <form className="form_1" onSubmit={onSubmit} >
                ...
                <div>
                    <input type="submit" value="Log In" className="form_1_elemenet_submit" />
                </div>
